package com.nttdata.casestudy.mvc;
...
public class MvcUtil {
	...
	public static Map buildHandlers(final String propsFile) throws MvcException {
		final Map<String, HttpRequestHandler> handlers = new HashMap();
		...
		try {
			...
			while (proKeys.hasMoreElements()) {
				...
				if (checkInterface(handClazz, "com.nttdata.casestudy.mvc.HttpRequestHandler"))
				{
					...
					throw new MvcException(
							"Class does not implement com.nttdata.casestudy.mvc.HttpRequestHandler interface");
				}
	...
	public static Map<String, HttpRequestHandler> buildHandlers(final String propsFile) throws MvcException {
		final Map<String, HttpRequestHandler> handlers = new HashMap<>();
		final Properties props = new Properties();
		FileInputStream proStream = null;
		try {
